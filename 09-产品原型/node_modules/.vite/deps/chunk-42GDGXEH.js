...
import {
  ...
  size,
  useFloating
} from "./chunk-VHW3ES2X.js";
import {
  useSize
} from "./chunk-QNSODRDP.js";
import {
  createContextScope
...
var Popper = __name2((props) => {
  ...
  const [placementState, setPlacementState] = React2.useState(void 0);
...
var PopperAnchor = React2.forwardRef(
  __name2(function PopperAnchor2(props, forwardedRef) {
    ...
    const callbackRef = React2.useCallback(
      (node) => {
        ref.current = node;
        if (node) {
          onAnchorChange(node);
...
var PopperArrow = React2.forwardRef(
...
//# sourceMappingURL=chunk-42GDGXEH.js.map
