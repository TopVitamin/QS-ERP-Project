 ...
 * 一级菜单没有二级菜单的（工作台）直接进演示首页；有二级菜单的用 groups 挂 flyout。
 * 工作台一期后置，默认落地采购订单。
    ...
    groups: [
      {
        ...
        items: [
          ...
          { label: '实体仓', pageId: 'warehouse-physical' },
          { label: '逻辑仓', pageId: 'warehouse-logical' },
          { label: '物流商', pageId: 'base-logistics-carrier' },
          { label: '物流服务产品', pageId: 'base-logistics-product' },
