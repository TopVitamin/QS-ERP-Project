...
export const mockNotifications = [
  ...
  { id: 'notice-2', title: '入库单 CGRK-20260917-0001 已推送财务ERP', time: '09:51', tag: '库存', category: 'business', read: true, link: { pageId: 'purchase-inbound' } },
  { id: 'notice-3', title: '供应商「土豆供应商」资料待审核', time: '昨天 16:40', tag: '主数据', category: 'todo', read: false, link: { pageId: 'base-supplier' } },
