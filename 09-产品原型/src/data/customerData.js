...
const seedCustomers = [
  {
    ...
    addresses: [{ id: 'cus-a1', addressType: '收货', country: '中国', province: '广东省', city: '深圳市', district: '南山区', detailAddress: '科技园南路 88 号', contactName: '李静', contactPhone: '13800138011', postalCode: '', isDefault: true, remark: '' }],
